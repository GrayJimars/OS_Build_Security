 ...
 *          - Create three special files: dev_tty0, dev_tty1, dev_tty2, dev_tty3
...
PRIVATE void mkfs()
{
	...
	pi->i_size = DIR_ENTRY_SIZE * 6; /* 6 files:
					  * `.',
					  * `dev_tty0', `dev_tty1', `dev_tty2', 'dev_tty3'
					  * `cmd.tar'
					  */
